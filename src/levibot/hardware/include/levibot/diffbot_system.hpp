...
#ifndef LEVIBOT__DIFFBOT_SYSTEM_HPP_
#define LEVIBOT__DIFFBOT_SYSTEM_HPP_
...
#include "levibot/visibility_control.h"
#include "levibot/arduino_comms.hpp"
...
private:
  DiveJoint hw_interfaces_[2];
  Config config_;
  ArduinoComms bot_comms_;
};

}  // namespace levibot

#endif  // LEVIBOT__DIFFBOT_SYSTEM_HPP_
