...
def generate_launch_description():
    ...
    if 'IGN_GAZEBO_RESOURCE_PATH' in environ:
        environ['IGN_GAZEBO_RESOURCE_PATH'] =  environ['IGN_GAZEBO_RESOURCE_PATH'] + ':' + get_package_prefix('levibot') + '/share/levibot/worlds'
    else:
        environ['IGN_GAZEBO_RESOURCE_PATH'] =  get_package_prefix('levibot') + "/share/levibot/worlds"
    ...
    gz_bridge = Node(
        ...
        arguments=["--ros-args","-p", "config_file:=/home/sayed/ros_rolling_ws/src/levibot/levibot/simulation/config/bridges.yaml"],
        output='screen'    
    )
