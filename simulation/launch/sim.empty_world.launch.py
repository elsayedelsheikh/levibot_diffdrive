...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "use_sim_time",
            default_value="true",
            description='Use simulation (Gazebo) clock if true, else use system clock.',
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    gazebo_spawn_robot = Node(
        ...
        executable="create",
        name="spawn_levibot",
        arguments=["-name", "levibot", "-topic", "robot_description", "allow_renaming", "true", "-x", "0.0", "-y", "0.0", "-z", "1.0"],
        output="screen",
    )
